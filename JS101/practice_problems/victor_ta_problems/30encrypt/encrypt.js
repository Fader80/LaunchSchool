function wordHelper(argWord) {

  let secChar = argWord[1];
  let charArr = argWord.split('');
  charArr[0] = charArr[0].charCodeAt();
  charArr[1] = charArr[charArr.length  - 1];
  charArr[charArr.length - 1] = secChar;
